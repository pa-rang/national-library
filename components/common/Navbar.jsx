		...
		<NavbarWrapper theme={theme}>
			<div className="nav-container">
				<div className="nav__menu">
					<Image width="55px" height="55px" alt="menu" src="/assets/icons/Menu.svg" onClick={showDrawer} />
					<Drawer placement="left" closable={false} onClose={onClose} visible={visible}>
						<div style={{ marginBottom: '40px', marginLeft: '190px' }}>
							<Image src="/assets/icons/Close.svg" width="24px" height="24px" onClick={onClose} />
						</div>
						...
						<hr />
						<StyledButton size="SMALL" appearance="white">
							로그아웃
						</StyledButton>
						<StyledButton size="SMALL" appearance="white">
							개인정보수정
				...
				<div className="nav__logo">
					<Image width="200px" height="60px" alt="logo" src="/assets/icons/Logo.svg" />
					<p>디지털도서관 예약시스템</p>
				</div>
